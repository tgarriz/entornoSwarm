...
Vagrant.configure("2") do |config|
  ...
  config.vm.define "maestro" do |maestro|
    ...
    maestro.vm.network "private_network", ip: "192.168.99.100"
  ...
  config.vm.define "esclavo1" do |esclavo1|
    ...
    esclavo1.vm.network "private_network", ip: "192.168.99.150"
  ...
  config.vm.define "esclavo2" do |esclavo2|
    ...
    esclavo2.vm.network "private_network", ip: "192.168.99.152"
